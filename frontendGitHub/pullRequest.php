...
<br>
<div>
    <h1 class="hero-text">Pull Requests</h1>
</div>
...
<table style="width:100%" class="table" id="dataTable" >
    ...
    <tr style="font-weight:bold"><td>User ID</td><td>Pull Request ID</td><td>PR_num</td><td>PR_state</td><td>repo_ID</td><td>Created_at</td><td>Closed_at</td><td>Merged_at</td></tr>
    ...
    <?php
        ...
        while ($row = mysqli_fetch_assoc($result)){
            ...
            echo "<tr><td>{$row['userID']}</td><td>{$row['pr_id']}</td><td>{$row['pr_num']}</td><td>{$row['pr_state']}</td><td>{$row['repo_id']}</td><td>{$row['created_at']}</td><td>{$row['closed_at']}</td><td>{$row['merged_at']}</td></tr>";
