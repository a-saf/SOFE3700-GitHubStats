...
<br>
<div>
    <h1 class="hero-text">VIEW 1</h1>
</div>

<br><br>
<p> Description: Join of at least three tables </p>
<p> Displays the number of commits made on a Tuesday </p>
<br>
...
<table style="width:50%" class="table" id="dataTable" >
    ...
    <tr style="font-weight:bold"><td>Login Name</td><td>Tuesday</td></tr>
    <!--Using PHP to connect to database and fill up the table-->
    <?php

        //The Query Statement
        $sql = "SELECT u.login_name, c.Tue
        ...
        while ($row = mysqli_fetch_assoc($result)){
            ...
            echo"<tr><td>{$row['login_name']}</td><td>{$row['Tue']}</td></tr>";
        }
    ?>  
</table>
<br> 
