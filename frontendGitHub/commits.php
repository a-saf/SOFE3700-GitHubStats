...
<br>
<div>
    <h1 class="hero-text">Commits</h1>
</div>

<br><br>
<p> Description: Showing the Commits table </p>
<br>
...
<table style="width:100%" class="table" id="dataTable" >
    ...
    <tr style="font-weight:bold"><td>Repo ID</td><td>total_per_week</td><td>week</td><td>Sun</td><td>repo_name</td><td>Mon</td><td>Tue</td><td>Wed</td><td>Thurs</td><td>Fri</td><td>Sat</td></tr>
    ...
    <?php
        ...
        while ($row = mysqli_fetch_assoc($result)){
            ...
            echo "<tr><td>{$row['repo_id']}</td><td>{$row['total_per_week']}</td><td>{$row['week']}</td><td>{$row['Sun']}</td><td>{$row['repo_name']}</td><td>{$row['Mon']}</td><td>{$row['Tue']}</td><td>{$row['Wed']}</td><td>{$row['Thurs']}</td><td>{$row['Fri']}</td><td>{$row['Sat']}</td></tr>";
