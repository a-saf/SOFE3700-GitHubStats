...
<br>
<div>
    <h1 class="hero-text">VIEW 5</h1>
</div>

<br><br>
<p> Description: Nested queries with any of the set operations UNION, EXCEPT, or INTERSECT </p>
    <p> Shows repo ids of repos that have a smaller size of PHP and if it has an open issue </p>

<br>
    
<!--Giving Table ID to use with Javascript to parse it and use it for the Pie Chart-->
<table style="width:25%" class="table" id="dataTable" >
    
    <tr style="font-weight:bold"><td>Repository ID</td></tr>
    <!--Using PHP to connect to database and fill up the table-->
    <?php

        //The Query Statement
        $sql = "SELECT r.repositoryID
        ...
        while ($row = mysqli_fetch_assoc($result)){
            ...
            echo"<tr><td>{$row['repositoryID']}</td></tr>";
        }
    ?>  
</table>
<br> 
