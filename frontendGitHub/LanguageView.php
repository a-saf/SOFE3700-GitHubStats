...
<br>
<div>
    <h1 class="hero-text">Language View</h1>
</div>

<br><br>
<p> Description: Showcases a Doughnut chart of which programs the the repositories used and the Queried table to make the Doughnut chart </p>
<p>(You can hover your mouse on the chart to view which piece belongs to which program)</p>
<br>

<!-- Making a div and assigning area to place Pie Chart -->
<div class="chart" style="position: relative; height:60vh; width:90vw">
...
<table style="width:50%" class="table" id="dataTable" >
    ...
    <tr style="font-weight:bold"><td>languages</td><td>total</td></tr>
    <!--Using PHP to connect to database and fill up the table-->
    <?php

        //The Query Statement
        $sql = "SELECT languages, FORMAT(count(languages), 'D3') AS total 
                FROM repositories 
                GROUP by languages;";
        ...
        while ($row = mysqli_fetch_assoc($result)){
            ...
            echo"<tr><td>{$row['languages']}</td><td>{$row['total']}</td></tr>";
        }
    ?>  
</table>
<br> 
...
<script>
    ...
    function BuildChart(labels, values, chartTitle) {
        //connecting it to the canvas to draw chart in designated area
