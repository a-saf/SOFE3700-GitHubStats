...
CREATE TABLE `commits` (
  ...
  `total_per_week` int(11) DEFAULT NULL,
  ...
  `Thurs` int(11) DEFAULT NULL,
  `Fri` int(11) DEFAULT NULL,
  `Sat` int(11) DEFAULT NULL,
  PRIMARY KEY (`repo_id`,`week`),
  UNIQUE KEY `week_UNIQUE` (`week`),
  CONSTRAINT `repo_ID` FOREIGN KEY (`repo_id`) REFERENCES `repositories` (`repositoryID`) ON DELETE CASCADE ON UPDATE CASCADE
